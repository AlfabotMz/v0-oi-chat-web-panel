                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <FadeIn delay={400} direction="right" className="relative">
                        <div className="relative z-10 mx-auto max-w-[400px]">
                                ...
                                <div className="bg-[#E5DDD5] dark:bg-zinc-950 aspect-[9/18.5] rounded-[30px] overflow-hidden flex flex-col relative">
                                    ...
                                    <div className="bg-[#075E54] dark:bg-zinc-900 p-4 pt-8 text-white flex items-center gap-3">
                                        <div className="w-8 h-8 rounded-full bg-zinc-300 overflow-hidden relative">
                                            <Image src="/oichat-icon.jpg" alt="IA" fill />
                                        </div>
                                        <div>
                                    ...
                                    <div className="flex-1 p-4 flex flex-col gap-3 font-sans overflow-y-auto">
                                        <div className="bg-white dark:bg-zinc-800 p-3 rounded-lg rounded-tl-none shadow-sm max-w-[85%] text-xs">
                                            Olá! Vi que você tem interesse na Panela Elétrica. Temos em estoque! Gostaria de fechar o pedido agora?
                                        </div>
                                        <div className="bg-[#DCF8C6] dark:bg-violet-950 p-3 rounded-lg rounded-tr-none shadow-sm max-w-[85%] self-end text-xs">
                                            Sim, quero sim! Meu endereço é Zimpeto.
                                        </div>
                                        <div className="bg-white dark:bg-zinc-800 p-3 rounded-lg rounded-tl-none shadow-sm max-w-[85%] text-xs border-l-4 border-violet-500">
                            ...
                            {/* Floating Elements */}
                            <div className="absolute -right-6 top-1/4 p-4 bg-background dark:bg-zinc-900 rounded-2xl border border-border shadow-2xl animate-bounce duration-[4000ms] z-20">
                            ...
                            <div className="absolute -left-6 bottom-1/4 p-4 bg-background dark:bg-zinc-900 rounded-2xl border border-border shadow-2xl animate-bounce duration-[3000ms] delay-500 z-20">
                                <div className="flex items-center gap-3">
