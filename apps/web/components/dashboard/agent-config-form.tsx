...
import { AppInput, AppButton } from "@oichat/ui"
                          ...
                          <>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                              <div className="space-y-1.5 md:space-y-2">
                                ...
                                <AppInput value={product} onChange={(e) => setProduct(e.target.value)} placeholder="Ex: iPhone 15" className="h-9 md:h-10 text-xs md:text-sm bg-background/50" />
                              </div>
                              <div className="space-y-1.5 md:space-y-2">
                                <Label className="text-xs font-bold uppercase text-muted-foreground tracking-tight">Preço/Oferta</Label>
                                <AppInput value={amount} onChange={(e) => setAmount(e.target.value)} placeholder="Ex: 99.000 MT" className="h-9 md:h-10 text-xs md:text-sm bg-background/50" />
                              </div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                              <div className="space-y-1.5 md:space-y-2">
